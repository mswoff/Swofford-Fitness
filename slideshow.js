...
function slideShow() {
  ...
  function maxSlideWidth() {
    ...
    return document.getElementById("box1").clientWidth;
    //globals.slideImages[maxSlideIndex].getBoundingClientRect().width; // Account for the image's border, padding, and margin values. Note that getBoundingClientRect() is always in units of pixels.
  } // maxSlideWidth
